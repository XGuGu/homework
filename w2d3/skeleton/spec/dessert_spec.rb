...
describe Dessert do
  ...
  subject(:summer) { Dessert.new("summer", 60, chef) }
  ...
  describe "#initialize" do
    ...
    it "sets a quantity" do
      expect(summer.quantity).to eq(60)
    end
  ...
  describe "#eat" do
    it "subtracts an amount from the quantity" do
      summer.eat(15)
      expect(summer.quantity).to eq(45)
    end

    it "raises an error if the amount is greater than the quantity" do
      expect { summer.eat(70) }.to raise_error(RuntimeError)
      expect { summer.eat(80) }.to raise_error("not enough left!")
      expect { summer.eat(90) }.to raise_error(RuntimeError, "not enough left!")
    end
  end
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      ...
      expect(summer.serve).to eq("Chef Thai the Great Baker has made 60 summers!")
    end
  end
